...
public class Main_General_category extends AppCompatActivity implements arraySave, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.insta_btn).setOnClickListener(v -> {
            String link = "https://www.instagram.com";
            Intent intent = new Intent(Intent.ACTION_VIEW);
            intent.setData(Uri.parse(link));
            startActivity(intent);
        });
        findViewById(R.id.fb_btn).setOnClickListener(v -> {
            String link = "https://www.facebook.com";
            Intent intent = new Intent(Intent.ACTION_VIEW);
            intent.setData(Uri.parse(link));
            startActivity(intent);
        });
        findViewById(R.id.twitter_btn).setOnClickListener(v -> {
...
//            Intent cinemaIntent = new Intent(Main_General_category.this, WishlistActivity.class);
//            startActivity(cinemaIntent);
//        }
//        else if (id == R.id.category){
//            Intent intent = new Intent(Main_General_category.this, SelectCategoryClass.class);
//            startActivity(intent);
//        }
